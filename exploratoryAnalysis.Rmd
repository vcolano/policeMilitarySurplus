...
---
## Introduction
The United States Defence Department's [1033 program](https://en.wikipedia.org/wiki/1033_program) began in 1997, it allows for the transfer of excess military equipment to civilian law enforcement agencies. Most of the equipment obtained are things such as cold weather clothing, deisel generators and flashlights. However, a significant portion of it is explicitly combat-orientated in nature, such as M-16 rifles, tanks, and mine-resistant vehicles.  
...
ggplot(data = highest_spenders, aes(x=reorder(Area_name, -spending), y=spending)) + 
  ...
  xlab("Number of Counties") + ylab("Total Spending in USD") + 
